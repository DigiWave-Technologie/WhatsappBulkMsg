...
personalCampaignSchema.index({ userprofile: 1, createdAt: -1 });
personalCampaignSchema.index({ status: 1 });

module.exports = mongoose.model('PersonalCampaign', personalCampaignSchema);